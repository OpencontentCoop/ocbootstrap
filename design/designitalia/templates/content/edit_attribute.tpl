...
{foreach $content_attributes_grouped_data_map as $attribute_group => $content_attributes_grouped}
    ...
    <h2 class="Accordion-header js-fr-accordion__header fr-accordion__header" id="accordion-header-{$attribute_group}">
        <span class="Accordion-link u-text-r-s">{$attribute_categorys[$attribute_group]}</span>
    </h2>
    {/if}

    <div id="accordion-panel-{$attribute_group}" class="Accordion-panel{if $attribute_default_category|ne($attribute_group)} fr-accordion__panel js-fr-accordion__panel{/if}">
...
{/foreach}
    <h2 class="Accordion-header js-fr-accordion__header fr-accordion__header" id="accordion-header-contentactions">
        <span class="Accordion-link u-text-r-s">Informazioni e configurazioni generali</span>
    </h2>
    <div id="accordion-panel-contentactions" class="Accordion-panel fr-accordion__panel js-fr-accordion__panel">
