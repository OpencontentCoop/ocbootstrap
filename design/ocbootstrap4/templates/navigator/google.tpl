        ...
        {case match=0}
            <li class="page-item">
                <a class="page-link" href={concat($page_uri,$:item_previous|gt(0)|choose('',concat($:offset_text,$:item_previous)),$:view_parameter_text,$page_uri_suffix)|ezurl}>
                    <span class="text">&laquo;&nbsp;{"Previous"|i18n("design/admin/navigator")}</span>
                </a>
            </li>
        {/case}
        {case}
            <li class="page-item disabled">
                <span class="page-link text disabled">&laquo;&nbsp;{"Previous"|i18n("design/admin/navigator")}</span>
            </li>
        {/case}
        {/switch}
        ...
        {case match=1}
            <li class="page-item">
                <a class="page-link" href={concat($page_uri,$:offset_text,$:item_next,$:view_parameter_text,$page_uri_suffix)|ezurl}>
                    <span class="text">{"Next"|i18n("design/admin/navigator")}&nbsp;&raquo;</span>
                </a>
            </li>
        {/case}
        {case}
            <li class="page-item disabled">
                <span class="page-link text disabled">{"Next"|i18n("design/admin/navigator")}&nbsp;&raquo;</span>
            </li>
        {/case}
        {/switch}
    </ul>
