...
{if $content_object.can_edit}
    ...
    <button class="btn btn-link btn-xs px-0" type="submit" name="EditButton"><span class="fa-stack"><i class="fa fa-square fa-stack-2x"></i><i class="fa fa-pencil fa-stack-1x fa-inverse"></i></span></button>
{/if}
