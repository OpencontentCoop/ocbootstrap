...
{else}    
    ...
    {include uri='design:content/datatype/edit/ezobjectrelationlist_controls.tpl'}
        ...
        <div class="clearfix">
        <div class="pull-left">
            <input class="btn btn-sm btn-info" type="submit" name="CustomActionButton[{$attribute.id}_browse_objects]" value="{'Add existing objects'|i18n( 'design/standard/content/datatype' )}" title="{'Browse to add existing objects in this relation'|i18n( 'design/standard/content/datatype' )}" />
        </div>
        {include uri='design:content/datatype/edit/ezobjectrelationlist_ajaxuploader.tpl'}
    
        <div class="pull-right">
            <div class="input-group">
                <input type="text" class="form-control form-control-sm hide ezobject-relation-search-text" size="25" />
                <div class="input-group-append">
                    <button type="submit" class="hide ezobject-relation-search-btn btn btn-sm btn-info" name="CustomActionButton[{$attribute.id}_browse_objects]">
        ...
        <div class="list-group ezobject-relation-search-browse hide mb-2 mt-2"></div>
