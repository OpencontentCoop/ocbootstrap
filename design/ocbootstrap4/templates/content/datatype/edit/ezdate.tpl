...
{default attribute_base='ContentObjectAttribute' html_class='full' placeholder=false()}
    <div class="clearfix">
        ...
        <div class="form-inline date">
            <input placeholder="{'Day'|i18n( 'design/admin/content/datatype' )}"
                   id="{$id_base}_day"
                   class="form-control"
                   type="text"
                   name="{$attribute_base}_date_day_{$attribute.id}"
                   size="3"
            ...
            <input placeholder="{'Month'|i18n( 'design/admin/content/datatype' )}" id="{$id_base}_month"
                   class="form-control"
                   type="text"
                   name="{$attribute_base}_date_month_{$attribute.id}"
                   size="3"
        ...
        <div id="{$attribute_base}_date_cal_container_{$attribute.id}" style="display: none; position: absolute;z-index:1000"></div>
    </div>
{/default}
