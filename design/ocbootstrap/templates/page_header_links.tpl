...
{else}
    ...
    <li id="login" class="transition-showed">
        <a href="#login" title="show login form" class="show-login-form">{'Login'|i18n('design/ocbootstrap/pagelayout')}</a>
        <a href="#" title="hide login form" class="hide-login-form">{'Login'|i18n('design/ocbootstrap/pagelayout')}</a>
