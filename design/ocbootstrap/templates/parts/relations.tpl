...
<div class="panel panel-default">
  <table class="table" cellspacing="0" summary="{'Object relation list from current object.'|i18n( 'design/admin/node/view/full' )}">
  <tr>
...
<div class="panel panel-default">
  <table class="table" cellspacing="0" summary="{'Reverse object relation list to current object.'|i18n( 'design/admin/node/view/full' )}">
  <tr>
  ...
  {if $reverse_related_objects_count}
	  ...
	  {if $reverse_related_objects_count|lt(100)}
