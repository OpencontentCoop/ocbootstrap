...
<tr>
    <td>        
        <button class="btn btn-danger btn-sm" type="submit" name="CustomActionButton[{$attribute.id}_delete_binary]"  title="{'Remove the file from this draft.'|i18n( 'design/standard/content/datatype' )}"><i class="icon-trash"></i></button>
