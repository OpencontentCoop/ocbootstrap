	...
	{if $attribute.data_type_string|ne('ezimage')}		
	  ...
	  {else*}
        ...
        {if array( 'ezstring', 'ezinteger', 'ezkeyword', 'eztext', 'ezobjectrelationlist' )|contains( $attribute.data_type_string )}
          ...
          <span>
            <button class="inline-edit btn btn-xs btn-info" data-input="{$inputTag}" data-objectid="{$attribute.object.id}" data-attributeid="{$attribute.id}" data-version="{$attribute.version}"><span class="glyphicon glyphicon-pencil"></span></button>
